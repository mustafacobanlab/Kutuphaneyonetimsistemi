    ...
    public class KitapTuruController : Controller
    {
        ...
        public IActionResult Ekle(KitapTuru kitapTuru)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["basarili"] = "Kitap Türü Başarılıyla Oluşturuldu.";
        ...
        public IActionResult Guncelle(KitapTuru kitapTuru)
        {
            if (ModelState.IsValid)
            {
                ...
                _kitapTuruRepository.Kaydet(); //SaveChanges yapmazsanız bilgiler veritabanına eklenmez.
                TempData["basarili"] = "Kitap Türü Başarılıyla Güncellendi.";
                return RedirectToAction("Index");
            }
            return View();
        }
        ...
        public IActionResult SilPOST(int? id)
        {
            ...
            TempData["basarili"] = "Kitap Türü Başarılıyla Silindi.";
            return RedirectToAction("Index");
        }
    }
}
